...
test("parseAttestation should work", () => {
  ...
  const notAfter = attestation.signedInfo.validity.notAfter.generalizedTime.getTime();
  const notBefore = attestation.signedInfo.validity.notBefore.generalizedTime.getTime();
