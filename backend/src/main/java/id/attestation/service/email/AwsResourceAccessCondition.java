...
public class AwsResourceAccessCondition implements Condition {
    ...
    public boolean matches(ConditionContext context) {
        if (StringUtils.isNotEmpty(System.getProperty("aws.accessKeyId")) &&
                StringUtils.isNotEmpty(System.getProperty("aws.secretAccessKey"))) {
            return true;
        }

        if (StringUtils.isNotEmpty(System.getenv("AWS_ACCESS_KEY_ID")) &&
